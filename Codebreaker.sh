...
##   Codebreaker 	: 	Automated Phishing Tool
##   Author 	: 	CODEBREAKER/KINGPHISHER 
##   Version 	: 	1
## Message   :    this tool is for phishers only use your knowledge in good ways 
...
${GREEN}[${WHITE}-${GREEN}]${CYAN} Tool Created by Codebreaker ${WHITE}
EOF
}
...
about() {
	{ clear; banner; echo; }
	cat <<- EOF
		${GREEN}Author   ${RED}:  ${ORANGE}codebreaker
		${RED}Message of code to the user 
		${BLUE}This tool is for phishers only use your knowledge in good ways
		${GREEN}Version  ${RED}:  ${ORANGE}1.0

		${REDBG}${WHITE} Thanks :  to the user of this tool thank you for using my tool ${RESETBG}
		${RED} WEBSITE FB : https://www.facebook.com/profile.php?id=100083134174609
